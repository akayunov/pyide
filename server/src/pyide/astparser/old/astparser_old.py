...
from pyide.astparser.old.nodeparsers_old import Parsers
from pyide.astparser import nodeparsers
...
class AstParser:
    ...
    def search_token(self, token_info):
        parsers = nodeparsers.Parsers(self)
        result = parsers.parsers[self.ast_tree.__class__](self.ast_tree, token_info)
        print('scope_structure:', parsers.scope_tree)
        return result
    ...
    def parse_content(self):
        ...
        # print('parsers, self.ast_tree.__class__', parsers.parsers_dict.keys(), parsers, str(hash(self.ast_tree.__class__)))
        # getattr(parsers, str(hash(self.ast_tree.__class__)))(self.ast_tree)
        parsers.parsers[self.ast_tree.__class__](self.ast_tree)
